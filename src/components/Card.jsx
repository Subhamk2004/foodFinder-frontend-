...
function Card({
    ...
    return (
        <div className='w-1/3 min-card-w max-w-96  p-2 border border-black mt-2 rounded-2xl bg-white shadow-md shadow-gray-500 group'>
            <div className='transition-all duration-300 ease-in-out w-full  relative overflow-hidden rounded-xl'>
                <img src={CardImg}
            ...
            <div className='flex w-full mt-1 items-center gap-2'>
                ...
                <select className='text-white shadow-md shadow-black bg-green-700 rounded-lg h-10 pr-1 pl-1'>
