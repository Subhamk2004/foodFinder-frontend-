...
function Carousel() {
    ...
    return (
        <div className='relative w-full h-full overflow-hidden flex justify-center'>
            <img src={Img}
                className='p-2 rounded-3xl h-full w-full max-w-8xl custom-max-height'
            />
            <form className='absolute top-10 w-2/3 flex items-center justify-center'>
                <input placeholder='Search' className='w-full p-2 rounded-l-lg bg-amber-100 shadow-md shadow-black focus:outline-none text-lg'
                type='search'/>
                <button type='submit' 
                className='bg-amber-600 p-2 shadow-md shadow-black rounded-r-lg text-lg -ml-1'>
                    Search
                </button>
            </form>
        </div>
