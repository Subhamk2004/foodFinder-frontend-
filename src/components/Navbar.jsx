...
function Navbar() {
  ...
  return (
    <div className='w-full h-auto sticky top-0 p-1 sm:p-3 z-10'>
      <nav className='p-2 w-full bg-lime-400 bg-opacity-90 flex flex-row rounded-xl overflow-hidden sm:hover:p-3 transition-all duration-300 ease-in-out border border-black '>
